...
public class HeroStatesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hero_states);
        // Get the intent
        Intent i = getIntent();
        ...
        tvTechnicalProwess = (TextView) findViewById(R.id.textViewTechnicalPower);
